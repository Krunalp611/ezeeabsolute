...
<style>
#topnav .slidecontainer {
    position: relative;
}
#topnav .slidecontainer.stickynav {
    position: fixed;
}
.page_wrapper {
    width: 100%;
...
.cta-caption a, .footer-caption a{
...
#mobilefriendly-be .caption h1 {
    font-size: 30px;
    color: #fff;
    margin: 50px auto 5px;
}
#mobilefriendly-be .caption p {
    font-size: 16px;
    color: #fff;
    margin: 0;
    font-weight: 300;
...
<script>
    jQuery(function(){
        ...
        jQuery.ajax({
            type: "GET",
            crossdomain : true,
            url: "https://www.ezeereservation.com/featurepage/mobile-friendly-booking-engine.php",
